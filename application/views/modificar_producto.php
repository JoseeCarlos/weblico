      ...
      <div class="container d-flex align-items-center px-4">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active"><button class="nav-link pl-0 btn">Inicio</button></li>
            <li class="nav-item"><button class="nav-link pl-0 btn">Productos</button></li>
        <li class="nav-item"><a href="<?php echo base_url();?>index.php/usuario/listarusuarios" class="nav-link pl-0 btn">Usuarios</a></li>
                
            <li class="nav-item"><button class="nav-link pl-0 btn">Clientes</button></li>
            
            <li class="nav-item"><button class="nav-link pl-0 btn">Contactos</button></li>
          </ul>
        </div>
      </div>
    </nav>
      ...
      <div class="container-fluid px-4">
        <div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Modificar de</span> Producto</h2>
        ...
        <div class="col-md-6">
        <div class="container">
          <form id="sign_up" action="<?php echo base_url(); ?>index.php/producto/modificardb" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <?php foreach ($producto->result() as $row) {
                                                ...
                                                <input type="text" class="form-control" name="nombre" placeholder="Nombre" value="<?php echo $row->nombre; ?>" required autofocus>                                            
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="precio" placeholder="Precio" value="<?php echo $row->precio; ?>" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="descripcion" placeholder="Descripcion" value="<?php echo $row->descripcion; ?>" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="foto" placeholder="foto" value="<?php echo $row->foto; ?>" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="stock" placeholder="Stock" value="<?php echo $row->stock; ?>" required autofocus>     
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="fechaVencimiento" placeholder="fecha de vencimiento" value="<?php echo $row->fechaVencimiento; ?>" required autofocus>       
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="presentacion" value="<?php echo $row->presentacion; ?>" placeholder="Presentacion" class="form-control" required>       
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <button class="btn btn-block btn-lg btn-warning waves-effect" type="submit">Modificar producto</button>     
                                        </div>
                                    </div>
                                </div>
                            </div> 
