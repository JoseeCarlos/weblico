    ...
    <section class="ftco-services ftco-no-pb">
        ...
        <section class="ftco-section">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Cambio de</span> Contraseña</h2>
        ...
        <div class="col-md-6">
        <div class="container">
        <form action="<?php echo base_url();?>index.php/usuario/cambiocontra" method="POST" enctype="multipart/form-data">
  <div class="form-group">
    <label for="exampleInputEmail1">Codigo de Recuperacion</label>
    <input type="text" name="codigo" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Escriba el codigo enviado a su telefono" required>
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Contraseña</label>
    <input type="password" name="pass1" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Escriba su nueva contraseña"  required>
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Repita su Contraseña</label>
    <input type="text" name="pass2" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Repita su contraseña" required >
   
  </div>
 
  
  <button type="submit" class="btn btn-primary ">Enviar Codigo de Recuperacion</button>
</form>
