...
<html lang="es">
    ...
    <section class="ftco-services ftco-no-pb">
        ...
        <section class="ftco-section">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Registro de</span> Usuarios</h2>
        ...
        ?>
        <form action="<?php echo base_url();?>index.php/usuario/modificardb" method="POST" >
        <input type="text" name="id" hidden value="<?php echo $row->Id; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Escriba su Nombre" required >
  <div class="form-group">
    <label for="exampleInputEmail1">Nombre</label>
    <input type="text" name="nombre" value="<?php echo $row->nombre; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Escriba su Nombre" required >
   
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Primer Apellido</label>
    <input type="text" value="<?php echo $row->primerApellido; ?>" name="primerApellido" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Escriba su Apellido" required>
   
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Segundo Apellido</label>
    <input type="text" value="<?php echo $row->segundoApellido; ?>" name="segundoApellido" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Escriba su apellido">
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Fecha de Nacimiento</label>
    <input type="date" value="<?php echo $row->fechaNacimiento; ?>" name="fechaNacimiento" max="2002-01-01" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
  ...
  <div class="form-group">
    ...
    <input type="email" value="<?php echo $row->email; ?>" name="email" class="form-control" placehoder="Escriba su Correo" required>
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Nombre Usuario</label>
    <input type="text" value="<?php echo $row->nombreUsuario; ?>" readonly name="nombreUsuario" class="form-control" placehoder="Escriba su nombre de Usuario" required maxlegt=>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Telefono</label>
    <input type="text" value="<?php echo $row->telefono; ?>" name="telefono" class="form-control" placehoder="Escriba su Numero de telefono" required >
  ...
  <button type="submit" class="btn btn-primary ">Modificar Usuario</button>
     ...
     ?>
        ...
        <div class="col-md-6">
        <div align="center"><img width="100%" height="1000px" src="<?php echo base_url();?>images/03.jpg" alt=""></div>
        </div>
        </div>
