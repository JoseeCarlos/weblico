      ...
      <div class="container-fluid px-4">
        <div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Registrar </span>nueva categoria</h2>
        ...
        <form action="<?php echo base_url();?>index.php/producto/listaproductos" method="POST">
        <p> <button href="#" class="btn btn-primary px-4 py-3 mt-3">Ver producto</button></p>
        </form>        
         ...
         <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <h2 class="card-inside-title">Agregar categoria</h2>
                            <form id="sign_up" action="<?php echo base_url(); ?>index.php/categoria/agregar_categoriadb" method="POST">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" pattern="[a-z A-Z]+" name="nombreCategoria" placeholder="Ingrese el nombre de la categoria" required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="demo-button">
                                            <button class="btn btn-block btn-lg btn-warning waves-effect" type="submit">Agregar categoria</button>
                                        </div>
                                    </div>
                                </div>
                            </div> 
