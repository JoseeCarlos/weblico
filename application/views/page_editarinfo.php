...
<html lang="es">
    ...
    <section class="ftco-services ftco-no-pb">
        ...
        <section class="ftco-section">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Modificar</span> Informacion</h2>
        ...
        <form action="<?php echo base_url();?>index.php/usuario/actualizarinfo" method="POST">
        
  <div class="form-group">
    <label for="exampleInputEmail1">Nombre</label>
    <input type="text" name="nombre"  value="<?php echo $row->nombre; ?>" class="form-control"   placeholder="Escriba su Nombre" required >
   
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Primer Apellido</label>
    <input type="text" name="primerApellido" value="<?php echo $row->primerApellido; ?>" class="form-control"   placeholder="Escriba su Apellido" required>
  
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Segundo Apellido</label>
    <input type="text" name="segundoApellido"  value="<?php echo $row->segundoApellido; ?>" class="form-control"  placeholder="Escriba su apellido">
   
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Fecha de Nacimiento</label>
    <input type="date" name="fechaNacimiento" value="<?php echo $row->fechaNacimiento; ?>"  max="2002-01-01" class="form-control" >
  ...
  <div class="form-group">
    ...
    <input type="text" name="email" value="<?php echo $row->email;?>" class="form-control" placehoder="Escriba su Correo" required>
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Nombre Usuario</label>
    <input type="text" name="nombreUsuario" value="<?php echo $row->nombreUsuario;?>" class="form-control" placehoder="Escriba su nombre de Usuario" required maxlegt=>
  ...
  <button type="submit" class="btn btn-primary btn-lg">Modificar</button>
    ...
    ?>
        ...
        <br>
        <div class="container">
        <form action="<?php echo base_url();?>index.php/usuario/newpassword" method="POST" >
           <label style="text-align: center;" > Cambio de contraseña</label>
        <div class="form-group">
    <label for="exampleInputEmail1">Contraseña Actual</label>
    <input type="password" name="pass1"  class="form-control" placehoder="Escriba su Contraseña" required >
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Nueva Contraseña</label>
    <input type="password" name="pass2"  class="form-control" placehoder="Escriba su Contraseña" required >
    
  </div>
   <div class="form-group">
    <label for="exampleInputEmail1">Repita su Contraseña</label>
    <input type="password" name="pass3" class="form-control" placehoder="Escriba su Contraseña" required >
