      ...
      <div class="container-fluid px-4">
        <div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Busqueda de</span> Productos</h2>
        ...
        <div class="row">
          ...
          <div class="col-md-3 course ftco-animate">
            ...
            <div class="img" style="background-image: url(<?php echo base_url();?>images/<?php echo $row->foto;?>); width: 300px; height: 380px;"></div>
            <div class="text pt-4">             
              <h3><a>Nombre: <?php echo $row->nombre;?></a></h3>
              <h3><a>Precio: <?php echo $row->precio;?></a></h3>
              <h3><a>Presentacion: <?php echo $row->presentacion;?></a></h3>
              <p>
              <?php echo form_open_multipart('producto/carrito'); ?>
                  ...
                  <input type="number" placeholder="Cantidad" style="width : 100px;" name="cantidad" min="1" max="<?php echo $row->stock; ?>" required>
