      ...
      <div class="container-fluid px-4">
        <div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Registrar</span>nuevo producto</h2>
                        ...
                        <div class="body">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <label>Seleccione una categoria</label>
                                        <?php echo form_open_multipart('producto/mostrarProductos'); ?>
                                            <select id="selectCategoria" class="form-control" name="categoria">
                                              
                                              <?php foreach ($categoria->result() as $row) {
                                              ?>
                                              
                                              <option name="idcategoria" value="<?php echo $row->Id; ?>"><?php echo $row->nombreCategoria; ?></option>
                                              <?php
                                            }
                                            ?>
                                            </select>
                                            <button type="submit" >Mostrar productos disponibles</button>
                                            <?php echo form_close(); ?>
                                            
                                      
                                    </div>
                                    <div class="form-group">
                                      <form method="POST" action="<?php echo base_url(); ?>index.php/producto/carritoCompra">
            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>Nombre: <?php echo $row->nombre; ?></b></h2>
                      <p class="text-muted text-sm">Precio: <?php echo $row->precio; ?></p> 
                      <p class="text-muted text-sm">Presentacion: <?php echo $row->presentacion; ?></p>
                    </div>
                    <div class="col-5 text-center">
                      <img src="<?php echo base_url();?>images/<?php echo $row->foto; ?>" alt="" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
                <div class="card-footer">
                  <div class="text-right">                    
                    <a href="#" class="btn btn-sm btn-primary">
                      <i class="fas fa-user"></i> Agregar al carrito
                    </a>
                  </div>
                </div>
              </div>
