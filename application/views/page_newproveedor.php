...
<html lang="es">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item"><a href="<?php echo base_url();?>index.php/productos/" class="nav-link pl-0 btn">Productos</a></li>
    ...
    <section class="ftco-services ftco-no-pb">
        ...
        <section class="ftco-section">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4"><span>Registro de Nuevo</span> Proveedor</h2>
        ...
        <div class="col-md-6">
        <div class="container">
        <form action="<?php echo base_url();?>index.php/proveedor/agregarproveedor" method="POST" >
  ...
  <div class="form-group">
    ...
    <input type="text" name="telefono" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Telefono" required>
   
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Direccion</label>
    <input type="text" name="direccion" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Direccion" required>
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Latitud</label>
    <input type="text" name="longitud" id="latitud"  class="form-control"  aria-describedby="emailHelp" required>
   
  </div>
 
  <div class="form-group">
    <label for="exampleInputEmail1">Longitud</label>
    <input type="text" id="longitud" name="latitud" class="form-control"  required>
  ...
  <button type="submit" class="btn btn-primary btn-lg ">Crear Proveedor</button>
</form>
